...
module "gen3" {
  ...
  gearbox_access_key         = module.commons.gearbox-bot_user_id
  gearbox_secret_key         = module.commons.gearbox-bot_user_secret
  gearbox-data-bucket            = module.commons.gearbox-data-bucket

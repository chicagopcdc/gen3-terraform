...
terraform {
  backend "s3" {
    ...
    bucket = "terraform-state-luca-play-677809101101"
...
locals {
  ...
  revproxy_arn                  = "arn:aws:acm:us-east-1:677809101101:certificate/63c2486a-28b5-487b-90d9-d48f224b17c1"
  ...
  user_yaml_bucket_name = "gen3-luca-play-users"
...
#   csoc_account_id            = "677809101101"
#   # The CIDR range of the CSOC account, only needed for CSOC setup.
#   peering_cidr                = "10.0.0.0/28"
#   # The vpc of the CSOC
#   peering_vpc_id               = "vpc-0269f03404bdee479"
...
module "commons" {
  # source = "git::github.com/chicagopcdc/gen3-terraform.git//tf_files/aws/commons?ref=a62f97b5ea154f7c2a54b50bc94ad14b31b40cd5"
...
module "gen3" {
  # source = "git::github.com/chicagopcdc/gen3-terraform.git//tf_files/gen3?ref=a62f97b5ea154f7c2a54b50bc94ad14b31b40cd5"
  ...
  deploy_gen3              = false
  create_dbs               = false
  cognito_discovery_url    = local.deploy_cognito ? "https://${aws_cognito_user_pool.cognito_pool[0].endpoint}/.well-known/openid-configuration" : null
  cognito_client_id        = local.deploy_cognito ? aws_cognito_user_pool_client.cognito_client[0].id : null
  cognito_client_secret    = local.deploy_cognito ? aws_cognito_user_pool_client.cognito_client[0].client_secret : null
  gitops_repo              = "https://github.com/chicagopcdc/gen3-gitops"
  helm_repo                = "https://github.com/chicagopcdc/gen3-helm"

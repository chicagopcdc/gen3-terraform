...
terraform {
  backend "s3" {
    ...
    bucket = "pcdc-dev-009732147623-gen3-tfstate" # Update to represent your environment
...
locals {
  ...
  availability_zones            = ["us-east-1a", "us-east-1b", "us-east-1c", "us-east-1d"] # ex. ["us-east-1a", "us-east-1c", "us-east-1d"]
  ...
  ssh_key                = "ssh-rsa "
